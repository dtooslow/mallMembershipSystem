...
<head>
    ...
    <title>Become a Member | NCCC Mall</title>
...
<body>
    ...
    <div class="auth-card">
        ...
        <h2 style="text-align: center; margin-bottom: 2rem;">Join Our Membership</h2>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button type="submit" class="btn-primary">Register Free Account</button>
